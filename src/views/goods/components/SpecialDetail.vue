    ...
    <el-form ref="postForm" :model="postForm" :rules="rules" class="form-container">
      <div class="createPost-main-container">
        <el-form-item label="商品名称">
          <el-input v-model="postForm.goods_name" style="width:300px;" readonly />
        </el-form-item>
        <el-form-item label="规格名称">
          <el-input v-model="postForm.special_name" style="width:300px;" readonly />
        </el-form-item>
        <el-form-item label="商品单价">
          <el-input v-model="postForm.goods_price" style="width:300px;" readonly />
        </el-form-item>
        <el-form-item label="最大购买数量">
          <el-input v-model="postForm.max_buy" style="width:300px;" readonly />
        </el-form-item>
